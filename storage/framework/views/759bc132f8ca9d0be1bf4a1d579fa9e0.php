        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-white">
                ...
                <div class="bg-white dark:bg-gray-800 text-black dark:text-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="text-2xl font-bold">₱<?php echo e(number_format($dailySales, 2)); ?></p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 text-black dark:text-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="text-2xl font-bold">₱<?php echo e(number_format($monthlySales, 2)); ?></p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 text-black dark:text-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="text-2xl font-bold">₱<?php echo e(number_format($allTimeSales, 2)); ?></p>
                </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            ...
                            <p>Not Available Slots: <span class="font-bold text-red-600"><?php echo e($notAvailableSlots); ?></span>
                            </p>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            ...
                            <p>Total Value of Reserved Slots: <span
                                    class="font-bold text-green-600">₱<?php echo e(number_format($totalValueOfReservedSlots, 2)); ?></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $slotsByFloor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p class="text-sm">Floor <?php echo e($floor->floor_number); ?>: (Total:
                                    <?php echo e($floor->total_slots); ?>) <br>
                                <div class="text-sm">
