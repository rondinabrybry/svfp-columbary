...
<div class="max-w-7xl container mx-auto p-4">
    <div class="flex justify-between items-center">
        ...
        {{-- <a href="{{ route('columbary.create') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded">
            Add New Slot
        </a> --}}
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $slot->status === 'Available' ? 'bg-green-50' : ($slot->status === 'Reserved' ? 'bg-yellow-50' : 'bg-red-50') }}">
                            ...
                            <td class="border border-gray-300 px-4 py-2">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('columbary.delete', $slot->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
