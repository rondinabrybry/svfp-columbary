...
class floor2 extends Seeder
{
    public function run()
    {
        ...
        foreach ($vaultUpdates as $oldVaultNumber => $newVaultNumber) {
            ...
            if ($updatedRows > 0) {
                echo "Successfully updated $updatedRows rows where floor_number is 2 and vault_number is $oldVaultNumber to vault_number $newVaultNumber.\n";
            } else {
                echo "No rows were updated where floor_number is 2 and vault_number is $oldVaultNumber.\n";
            }
        }
